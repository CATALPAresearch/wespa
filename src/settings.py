...
period_1_arr = {
    ...
    'SS2025': ["25-16", "25-17"],             # 
    'WS2025_26': ["25-43", "25-44"],          # 20.10. – 02.11.25
}
...
period_2_arr = {
    ...
    'SS2023': ["23-18", "23-19", "23-20"],    # 01.05.23 – 21.05.23, KW 18-20
    ...
    'SS2025': ["25-18", "25-19", "25-20"],    # 
    'WS2025_26': ["25-45", "25-46", "25-47"], # 03.11. – 23.11.25
}
...
period_3_arr = {
    ...
    'SS2023': ["23-21", "23-22", "23-23"],          # 22.05.23 – 11.06.23, KW 21-23
    ...
    'SS2025': ["25-21", "25-22", "25-23"],          # 
    'WS2025_26': ["25-48", "25-49", "25-50"],       # 24.11. – 14.12.25
}

semester_form_to_arr = {
    'SS2021': [(2021, 4, 1), (2021, 9, 30)], 
    'WS2021_22': [(2021, 10, 1), (2022, 3, 31)],
    'SS2022': [(2022, 4, 1), (2022, 9, 30)], 
    'WS2022_23': [(2022, 10, 1), (2023, 3, 31)],
    'SS2023': [(2023, 4, 1), (2023, 9, 30)], 
    'WS2023_24': [(2023, 10, 1), (2024, 3, 31)], 
    'SS2024': [(2024, 4, 1), (2024, 9, 30)], 
    'WS2024_25': [(2024, 10, 1), (2025, 3, 31)],
    'SS2025': [(2025, 4, 1), (2025, 9, 30)],  
    'WS2025_26': [(2025, 10, 1), (2026, 3, 31)],
}
